var mensData = [
  ...
  },
  {
    ...
    name: "MEN'S REEBOK TRAINING  POLO T-SHIRTS",
    price: 769,
  ...
  },
  {
    ...
    name: "MEN'S REEBOK TRAINING WORKOUT  T-SHIRT  ",
    price: 1299,
...
function displayData(mensData) {
  ...
  mensData.forEach(function (menData) {
    ...
    img.setAttribute("src", menData.image_url);

    var name = document.createElement("p");
    name.innerText = menData.name;

    var price = document.createElement("p");
    price.innerText = "₹ " + menData.price;
